...
export const semanas: Semana[] = [
  {
    ...
    actividades: [
      ...
      },
      {
        ...
        docentes: ['Burgos', 'Puicón', 'Dueñas', 'Vaca', 'Vásquez'],
  ...
  },
  {
    ...
    actividades: [
      ...
      },
      {
        ...
        tipo: 'LAB',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Práctica 4 — Coloración fúngica',
        fecha: 'Sem 3 · según grupo',
        hora: '—',
        subtemas: ['Hongos filamentosos y levaduriformes'],
        docentes: [],
      },
      {
        id: 'clase-10',
        tipo: 'MAGISTRAL',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Clase 10 — Introducción a la Micología',
        fecha: '13 may',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'LAB',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Práctica 5 — Coloración fúngica (cont.)',
        fecha: 'Sem 3 · según grupo',
        hora: '—',
        subtemas: [],
        docentes: [],
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Clase 11 — Regulación del Metabolismo y Fisiología de Hongos',
        fecha: '15 may',
        hora: '09:00–11:00',
    ...
    actividades: [
      {
        ...
        tipo: 'LAB',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Práctica 6 — Caracterización de hongos',
      ...
      },
      {
        ...
        tipo: 'LAB',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Práctica 7 — Caracterización de hongos (cont.)',
        fecha: 'Sem 4 · según grupo',
        hora: '—',
        subtemas: [],
        docentes: [],
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'Clase 12 — Interacción Hongo–Hospedero',
        fecha: '20 may',
        hora: '09:00–11:00',
        subtemas: [
      ...
      },
      {
        ...
        tipo: 'TBL',
        unidad: 'VIROLOGIA_MICOLOGIA',
        titulo: 'TBL 1 — Hongos patógenos humanos',
        fecha: '22 may',
        hora: '09:00–11:00',
    ...
    actividades: [
      {
        ...
        titulo: 'Clase 15 — Parasitología generalidades · Protozoos 1',
        fecha: '25 may',
        hora: '09:00–11:00',
        subtemas: [
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'PARASITOLOGIA',
        titulo: 'Clase 17 — Protozoos intracelulares · Coccidios',
        fecha: '29 may',
        hora: '09:00–11:00',
    ...
    actividades: [
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'PARASITOLOGIA',
        titulo: 'Clase 18 — Protozoos con vectores biológicos',
        fecha: '1 jun',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        hora: '—',
        subtemas: ['Trichomonas', 'Trypanosoma', 'Leishmania', 'Plasmodium', 'Toxoplasma', 'Acanthamoeba', 'Naegleria'],
        docentes: [],
      },
      {
        id: 'sgp-2',
        ...
        hora: '2 sesiones de 1h',
        subtemas: [
          'Diagnóstico temprano, tratamiento y control de parásitos resistentes o emergentes en poblaciones vulnerables',
        ],
        docentes: ['Dra. Méndez', 'Dra. Chile', 'Dra. Verástegui', 'Mg. Cristóbal', 'Dr. Coronel'],
      },
      {
        id: 'practica-11',
        tipo: 'LAB',
        ...
        fecha: 'Sem 6 · según grupo',
        hora: '—',
        subtemas: ['Ascaris', 'Trichuris', 'Enterobius', 'Strongyloides', 'Uncinaria', 'Vectores de T. cruzi, Leishmania, Plasmodium'],
        docentes: [],
      },
      {
        id: 'clase-21',
        tipo: 'MAGISTRAL',
        unidad: 'PARASITOLOGIA',
        titulo: 'Clase 21 — Helmintos · Nematoda',
        fecha: '3 jun',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'PARASITOLOGIA',
        titulo: 'Clase 22 — Helmintos · Cestodos y Trematodos',
        fecha: '5 jun',
        hora: '09:00–11:00',
  ...
  },
  {
    ...
    actividades: [
      ...
      },
      {
        ...
        hora: '—',
        subtemas: ['Hymenolepis', 'Diphyllobothrium', 'Taenia', 'Echinococcus', 'Fasciola', 'Paragonimus', 'Schistosoma'],
        docentes: [],
      },
      {
        id: 'practica-13',
      ...
      },
      {
        ...
        tipo: 'TBL',
        unidad: 'PARASITOLOGIA',
        titulo: 'TBL 2 — Cambio climático y enfermedades metaxénicas parasitarias',
        fecha: '10 jun',
        hora: '09:00–11:00',
        subtemas: [],
  ...
  {
    id: 'sem-8-9',
    titulo: 'Semanas 8–9 — Inicio Bacteriología',
    fechas: '15 – 19 jun',
    actividades: [
      {
        id: 'clase-26',
        ...
        titulo: 'Clase 26 — Fisiología y Reproducción Bacteriana',
        fecha: '15 jun',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 27 — Microbiota Humana · Biología Molecular',
        fecha: '17 jun',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 28 — Metodologías de identificación bacteriana',
        fecha: '19 jun',
        hora: '09:00–11:00',
        subtemas: [],
    ...
    actividades: [
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 31 — Proceso infeccioso · Gram negativas',
        fecha: '22 jun',
        hora: '09:00–11:00',
        subtemas: [],
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 32 — Proceso infeccioso · Gram positivas',
        fecha: '24 jun',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 33 — Bacterias por vectores y transmisión sexual',
        fecha: '26 jun',
        hora: '09:00–11:00',
        subtemas: [],
    ...
    actividades: [
      {
        ...
        hora: '—',
        subtemas: ['Métodos microscópicos para diagnóstico de tuberculosis'],
        docentes: [],
      },
      {
        id: 'clase-34',
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 34 — Enteropatógenos bacterianos',
        fecha: '1 jul',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 35 — Resistencia antimicrobiana',
        fecha: '3 jul',
        hora: '09:00–11:00',
        subtemas: [],
    ...
    actividades: [
      {
        ...
        tipo: 'MAGISTRAL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Clase 36 — Bacterias asociadas a mortalidad infantil',
        fecha: '6 jul',
        hora: '09:00–11:00',
      ...
      },
      {
        ...
        tipo: 'LAB',
        unidad: 'BACTERIOLOGIA',
        titulo: 'Práctica 18 — Hisopado faríngeo',
        fecha: 'Sem 12 · según grupo',
        hora: '—',
        subtemas: ['Cultivo', 'Diferenciación Staphylococcus / Streptococcus'],
        docentes: [],
      },
      {
        id: 'tbl-3',
        tipo: 'TBL',
        unidad: 'BACTERIOLOGIA',
        titulo: 'TBL 3 — Enfermedades intrahospitalarias y biofilms',
        fecha: '8 jul',
        hora: '09:00–11:00',
        subtemas: [],
