...
/**
 * Estómago/tracto digestivo dorado — mismo SVG usado en la tarjeta del curso
 * Digestivo. Reutilizable: cabecera del sílabo.
 */
export default function DigestiveIcon({
  size = 22,
  color = '#c9a227',
  className,
  style,
  ...
  return (
    ...
    >
      <path
        fill={color}
        d="M389.503,117.203c-15.406-3.203-30.266-4.406-44-3.672c-7.547-0.313-14.266-0.906-20.172-1.734
