...
export default function KidneyIcon({
  ...
  return (
    ...
    >
      <path
        fill="#b83838"
        d="M260.934,163.337l11,80.373c108.325-17.297,81.482,268.275,81.482,268.275h58.437C432.915,82.057,260.934,163.337,260.934,163.337z"
      />
      <path
        fill="#d44a4a"
        d="M299.121,224.897c0,0,4.125-8.765,3.719-21.296c0.406-12.53-3.719-21.312-3.719-21.312c61.67-15.562,61.67-203.167-63.857-180.371C110.688,24.543,98.689,157.243,98.345,203.601c0.344,46.343,12.343,179.058,136.918,201.683C360.791,428.081,360.791,240.475,299.121,224.897z"
      />
      <g style={{ opacity: 0.2 }}>
        <path
          fill="#FFFFFF"
