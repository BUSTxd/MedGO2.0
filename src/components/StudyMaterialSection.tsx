...
import { useDetrasDeCandado, useCandadoCerrado } from './LockedContent';
...
/**
 * Sustituye la tarjeta «Video» por «Simulación» (ícono beaker). Se usa en las
 * prácticas de laboratorio, donde el material propio es un módulo interactivo
 * y no un video. Sin `href` la tarjeta queda como «Próximamente».
 */
export interface SimulacionRef {
  href?: string;
  desc?: string;
}
...
const BeakerIcon = () => (
  <svg width="22" height="22" viewBox="0 0 8 8" fill="currentColor">
