...
import { semanas, curso, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/fisica';
...
export default async function FisicaMedicinaPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <FisicaIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>Prácticas calificadas 40%</strong> — promedio de 4</span>
            <span className={styles.formulaChip}><strong>Exámenes 50%</strong> — I (10%) + Parcial (15%) + II (10%) + Final (15%)</span>
            <span className={styles.formulaChip}><strong>Trabajos grupales 10%</strong></span>
            <span className={styles.formulaChip}>Mínimo aprobación: <strong>11.00</strong> · prerrequisito U0665 Matemática</span>
          </div>
        </div>
