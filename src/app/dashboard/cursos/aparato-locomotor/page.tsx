...
export default async function LocomotorPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <LocomotorIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>Conocimientos 50%</strong> — Examen Final 50% + TBL 25% + Invertidas 25%</span>
            <span className={styles.formulaChip}><strong>Desempeño 50%</strong> — Anatomía 50% + Histología 30% + SGP 20%</span>
            <span className={styles.formulaChip}>Mínimo aprobación: <strong>11.00</strong> en cada componente · Sustitutorio 7 ene, máx. <strong>11</strong></span>
          </div>
        </div>
