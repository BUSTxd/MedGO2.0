...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/biologiaCelular';
...
export default async function ActividadPage({
  ...
  // Gating: las prácticas de laboratorio son libres; teoría, talleres,
  // autoaprendizajes e integraciones están detrás del plan Interno.
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="biologia-celular" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/biologia-celular" className={styles.backLink}>
          ← {semana.titulo}
        </Link>
