...
import { semanas, curso, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/biologiaCelular';
...
const UNIDAD_LABEL: Record<string, string> = {
  QUIMICA:      'La vida, bases químicas',
  METABOLISMO:  'Metabolismo celular y energía',
  ORGANIZACION: 'Organización interna de la célula',
  HERENCIA:     'Mecanismos moleculares de la herencia',
  EVALUACION:   'Evaluación',
};

export default async function BiologiaCelularPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <BiologiaCelularIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>EXP 30%</strong> — Examen parcial</span>
            <span className={styles.formulaChip}><strong>EXF 30%</strong> — Examen final</span>
            <span className={styles.formulaChip}><strong>D 40%</strong> — Prácticas de laboratorio + AFPD</span>
            <span className={styles.formulaChip}>Mínimo aprobación: <strong>11.00</strong> · truncamiento a 2 decimales</span>
          </div>
        </div>
        ...
        {semanas.map((semana) => (
          <section key={semana.id} className={styles.weekSection}>
            ...
            {semana.actividades.map((act) => {
              ...
              // Las prácticas de laboratorio son libres.
              ...
              const href = act.linkOverride ?? `/dashboard/cursos/biologia-celular/${act.id}`;
