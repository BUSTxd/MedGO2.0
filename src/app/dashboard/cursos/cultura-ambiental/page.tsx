...
const UNIDAD_LABEL: Record<string, string> = {
  AMBIENTAL:  'Educación y responsabilidad ambiental',
  EVALUACION: 'Entregables del proyecto',
};
...
export default async function CulturaAmbientalPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <CulturaAmbientalIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>Video de los ODS 15%</strong></span>
            <span className={styles.formulaChip}><strong>Mapa conceptual Política Ambiental UPCH 15%</strong></span>
            <span className={styles.formulaChip}><strong>Informe final 25%</strong> · <strong>Video del proyecto 15%</strong></span>
            <span className={styles.formulaChip}>Trabajo de campo presencial <strong>obligatorio</strong></span>
            <span className={styles.formulaChip}>Mínimo aprobación: <strong>11.00</strong> · pesos del sílabo por confirmar</span>
          </div>
        </div>
        ...
        {semanas.map((semana) => (
          <section key={semana.id} className={styles.weekSection}>
            ...
            {semana.actividades.map((act) => {
              ...
              // El trabajo de campo y las asesorías son libres.
