...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/culturaAmbiental';
...
export default async function ActividadPage({
  ...
  // Gating: el trabajo de campo y las asesorías son libres; los temas
  // autoinstructivos y los entregables están detrás del plan Interno.
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="cultura-ambiental" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/cultura-ambiental" className={styles.backLink}>
          ← {semana.titulo}
        </Link>
