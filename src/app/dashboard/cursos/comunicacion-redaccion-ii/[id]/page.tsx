...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/comunicacion';
...
export default async function ActividadPage({
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="comunicacion-redaccion-ii" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/comunicacion-redaccion-ii" className={styles.backLink}>
          ← {semana.titulo}
        </Link>
