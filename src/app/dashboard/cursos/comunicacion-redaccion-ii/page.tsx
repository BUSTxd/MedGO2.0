...
import { semanas, curso, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/comunicacion';
...
const UNIDAD_LABEL: Record<string, string> = {
  ORAL:       'La comunicación oral',
  LECTORA:    'La comprensión lectora',
  ESCRITA:    'La comunicación escrita',
  EVALUACION: 'Evaluación',
};

export default async function ComunicacionRedaccionPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <ComunicacionIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>Unidad 1 · Oral 10%</strong> — 2 entrevistas grupales</span>
            <span className={styles.formulaChip}><strong>Unidad 2 · Lectora 34%</strong> — 2 PC (14%) + Parcial (20%)</span>
            <span className={styles.formulaChip}><strong>Unidad 3 · Escrita 56%</strong> — PC normativa (6%) + 3 redacciones (30%) + Final (20%)</span>
            <span className={styles.formulaChip}>Mínimo aprobación: <strong>11.00</strong> · cámara obligatoria en evaluaciones</span>
          </div>
        </div>
        ...
        {semanas.map((semana) => (
          <section key={semana.id} className={styles.weekSection}>
            ...
            {semana.actividades.map((act) => {
              ...
              const href = act.linkOverride ?? `/dashboard/cursos/comunicacion-redaccion-ii/${act.id}`;
