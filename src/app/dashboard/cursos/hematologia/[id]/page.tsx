...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/hematologia';
...
export default async function ActividadPage({
  ...
  // Gating: las prácticas de laboratorio (LAB) son libres; las clases magistrales / TBL / SGP / repasos / exámenes están detrás del plan Interno.
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="hematologia" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/hematologia" className={styles.backLink}>
