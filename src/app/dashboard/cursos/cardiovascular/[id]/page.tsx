...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/cardiovascular';
...
export default async function CardiovascularActividadPage({
  params,
}: {
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="cardiovascular" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/cardiovascular" className={styles.backLink}>
