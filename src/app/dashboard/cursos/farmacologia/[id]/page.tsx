...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/farmacologia';
...
export default async function ActividadPage({
  ...
  // Gating: las practicas de laboratorio (LAB) son libres; el resto requiere plan Interno.
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="farmacologia" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/farmacologia" className={styles.backLink}>
