...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/endocrino';
...
export default async function ActividadPage({
  ...
  // Gating: las prácticas (anatomía, histología y el taller de antropometría)
  // son libres; las clases magistrales / invertidas / TBL / SGP / repasos /
  // exámenes están detrás del plan Interno.
  const isPractica =
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="endocrino-reproductor" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/endocrino-reproductor" className={styles.backLink}>
