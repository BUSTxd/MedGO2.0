...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/cienciasSociales';
...
export default async function ActividadPage({
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="ciencias-sociales" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/ciencias-sociales" className={styles.backLink}>
          ← {semana.titulo}
        </Link>
