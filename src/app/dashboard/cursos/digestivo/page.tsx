...
import { semanas, curso, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/digestivo';
...
const UNIDAD_LABEL: Record<string, string> = {
  DESARROLLO: 'Desarrollo del aparato digestivo',
  ESTRUCTURA: 'Estructura del sistema digestivo',
  FISIOLOGIA: 'Fisiología del sistema digestivo',
  ANATOMIA:   'Anatomía y disección',
  EVALUACION: 'Evaluación',
};

export default async function DigestivoPage() {
  ...
  return (
    <div className={styles.microPage}>
      ...
      <DigestiveIcon size={160} className={styles.microPageIcon} />
      ...
      <div className={styles.container}>
        ...
        <div className={styles.formulaCard}>
          ...
          <div className={styles.formulaItems}>
            <span className={styles.formulaChip}><strong>Conocimientos 50%</strong> — Examen Final 70% + TBL 15% + Invertidas 10% + Pasos cortos 5%</span>
            <span className={styles.formulaChip}><strong>Desempeño 50%</strong> — Anatomía 40% + Histología 30% + SGP 30%</span>
        ...
        {semanas.map((semana) => (
          <section key={semana.id} className={styles.weekSection}>
            ...
            {semana.actividades.map((act) => {
              ...
              const href = act.linkOverride ?? `/dashboard/cursos/digestivo/${act.id}`;
