...
import { findActividad, UNIDAD_COLOR, TIPO_BADGE } from '@/lib/data/digestivo';
...
export default async function ActividadPage({
  ...
  const detail = (
    <div className={styles.microPage}>
      <TrackRecentClass id={act.id} courseSlug="digestivo" title={act.titulo} />
      <div className={styles.container}>
        <Link href="/dashboard/cursos/digestivo" className={styles.backLink}>
