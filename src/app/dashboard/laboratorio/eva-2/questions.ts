...
export const QUESTIONS: Question[] = [
  {
    ...
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/oblicuo-superior.avif?v=2',
  ...
  },
  {
    ...
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/filum-terminal.avif?v=3',
    imageCaption: 'Componentes neuroanatómicos del filum terminale. (a) Cono medular: porción distal y afilada de la médula espinal. (b) Filum terminale internum: continuación intradural del filum terminale, que se extiende desde el cono medular. (c) Saco dural: vaina membranosa formada por la duramadre que rodea la médula espinal y sus raíces. (d) Filum terminale externum: porción del filum terminale que se extiende desde el saco dural hasta su inserción en el cóccix.',
  ...
  },
  {
    id: 'cristalino',
    region: 'Ojo',
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/cristalino-alt.webp',
    imageAlt: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/cristalino-guia.avif',
    imageCitation: 'olivia_sage22. (s.f.). Eye ball real diagram [Conjunto de estudio]. Quizlet. https://quizlet.com/579522420/eye-ball-real-diagram/',
    promptA: 'Nombre de la estructura señalada',
  ...
  },
  {
    id: 'recto-lateral',
    region: 'Órbita · M. extraoculares',
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/recto-lateral.webp',
    imageCaption: 'Vista superior, órbita derecha. El músculo elevador del párpado superior ha sido desprendido y retirado. 1: nervio frontal. 2: músculo recto superior. 3: nervio troclear. 4: músculo oblicuo superior. 5: músculo recto medial. 6: nervio lagrimal. 7: músculo recto lateral. 8: arteria oftálmica. 9: nervio nasociliar. 10: vena oftálmica superior.',
    imageCitation: 'Garrido, A., Fornos, P., Frigerio, J., Neirreitter, A., & Armand Ugón, G. (s.f.). Guide to the Anatomical Dissection of the Orbit Through the Superior Approach and Its Correlation with Surgical Procedures.',
    promptA: 'Nombre de la estructura señalada',
  ...
  },
  {
    id: 'esclerotica',
    region: 'Ojo',
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/esclerotica.avif',
    imageAlt: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/esclerotica-guia.webp',
    imageCitation: 'Bassett, D. L. (s.f.). A Stereoscopic Atlas of Human Anatomy [Imagen con licencia Creative Commons]. Lane Medical Library, Stanford University. https://lane.stanford.edu/biomed-resources/bassett/bassettView.html?bn=58-2',
    imageCaptionList: [
      'Córnea',
      ...
      'Ángulo del iris',
      'Músculo ciliar',
      'Procesos ciliares (de la corona ciliar)',
      'Orbículo ciliar',
      'Ora serrata',
      { text: 'Esclerótica', bold: true },
      'Coroides',
      'Retina',
      'Fóvea central',
  ...
  },
  {
    id: 'iris',
    region: 'Ojo',
    image: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/iris.avif',
    imageAlt: 'https://dabrwqwzvvnosdnmvlrp.supabase.co/storage/v1/object/public/examenes-img/neurologia/eva2/esclerotica-guia.webp',
    imageCitation: 'Bassett, D. L. (s.f.). A Stereoscopic Atlas of Human Anatomy [Imagen con licencia Creative Commons]. Lane Medical Library, Stanford University. https://lane.stanford.edu/biomed-resources/bassett/bassettView.html?bn=58-2',
    imageCaptionList: [
      'Córnea',
