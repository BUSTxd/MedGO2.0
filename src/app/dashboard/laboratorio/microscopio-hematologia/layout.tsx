...
export default function MicroscopioHematologiaLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('microscopio-hematologia')}>{children}</SeccionGate>;
}
