...
export default function FrotisSanguineoLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('frotis-sanguineo')}>{children}</SeccionGate>;
}
