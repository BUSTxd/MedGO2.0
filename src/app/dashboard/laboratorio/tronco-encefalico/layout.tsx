...
export default function TroncoEncefalicoLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('tronco-encefalico')}>{children}</SeccionGate>;
}
