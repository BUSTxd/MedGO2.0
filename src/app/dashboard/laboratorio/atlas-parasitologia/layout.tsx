...
export default function AtlasParasitologiaLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('atlas-parasitologia')}>{children}</SeccionGate>;
}
