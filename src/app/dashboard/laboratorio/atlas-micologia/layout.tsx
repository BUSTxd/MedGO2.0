...
export default function AtlasMicologiaLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('atlas-micologia')}>{children}</SeccionGate>;
}
