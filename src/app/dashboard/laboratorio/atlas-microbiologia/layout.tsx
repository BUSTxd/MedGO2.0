...
export default function AtlasMicrobiologiaLayout({ children }: { children: React.ReactNode }) {
  return <SeccionGate required={requiredPlanDeLab('atlas-microbiologia')}>{children}</SeccionGate>;
}
